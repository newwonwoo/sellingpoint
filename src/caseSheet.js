...
const VERDICT_STYLE = {
  ...
  "감정가 미공개": mkVerdict("8A5200", "FBE6BE"),
  "집행정지": mkVerdict("8A5200", "FBE6BE"),
  "항고 중": mkVerdict("8A5200", "FBE6BE"),
...
function metaSheet(meta) {
  const aoa = [
    ...
    [],
    ["감정가가 없는 경우 (실익판정 칸에 이 값이 찍힙니다)"],
    ["종결된 사건", "매각·취하·기각으로 끝났습니다. 법원이 종결 사건의 물건정보를 닫아 감정가를 못 가져옵니다."],
    ["집행정지", "절차가 멈춰 있습니다. 정지가 풀리면 조회됩니다."],
    ["항고 중", "항고가 제기돼 매각이 지연되고 있습니다."],
    ["감정가 미공개", "진행 중이지만 법원이 아직 감정가를 안 냈습니다. 사유는 공개되지 않습니다. 개시 8~9개월이 지난 사건에도 흔해서 언제 나올지 예측할 수 없습니다."],
    ["부동산 사건 아님", "자동차·선박·건설기계·유체동산 경매입니다. 이 도구는 부동산만 봅니다."],
    ["사건번호 확인 필요", "전국 51개 법원 어디에도 그 번호가 없습니다. 이때만 오타를 의심하세요."],
  ];
